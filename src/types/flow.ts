...
export const FLOW_STEPS: FlowStep[] = [
  ...
  { id: 3, path: "/flow/fixed-costs", label: "Fixed Costs", description: "List your non-negotiable monthly bills" },
  { id: 4, path: "/flow/spending-plan", label: "Spending Plan", description: "Create your Conscious Spending Plan" },
  { id: 5, path: "/flow/money-dials", label: "Money Dials", description: "Choose what matters most" },
  { id: 6, path: "/flow/summary", label: "Your Plan", description: "See your complete Rich Life plan" },
];
